...
import com.ecommerce.orderservice.infrastructure.security.JwtClaimsConverter;
 ...
 * - Operation-based claims extraction (order_claims)
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .oauth2ResourceServer(oauth2 -> oauth2
                .jwt(jwt -> jwt
                    // Custom converter to extract order_claims from JWT
